...
class DeviceDayMetrics extends Table {
  ...
  TextColumn get coverageState =>
      text()(); // 'complete', 'partial', 'notConnected', 'unsupported'
  ...
  TextColumn get unlockCoverage =>
      text().nullable()(); // 'complete', 'partial', 'none', 'collecting'
  TextColumn get notificationCoverage =>
      text().nullable()(); // 'complete', 'partial', 'none', 'collecting'
