...
class ScrollLogs extends Table {
  ...
  TextColumn get appName =>
      text()(); // instagram, youtube, twitter, reddit, other
  IntColumn get durationMinutes => integer()();
  IntColumn get dailyScoreImpact => integer()(); // negative value

  BoolColumn get recoveryActionTaken =>
      boolean().withDefault(const Constant(false))();
  TextColumn get recoveryActionType =>
      text().nullable()(); // breathing, walk, tinyTask, focusSprint

  TextColumn get intent =>
      text().nullable()(); // reply | lookup | rest | avoiding | scrolling
