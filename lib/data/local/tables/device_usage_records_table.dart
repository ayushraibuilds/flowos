...
class DeviceUsageRecords extends Table {
  ...
  TextColumn get packageName =>
      text()(); // Package name (Android) or token (iOS)
  ...
  TextColumn get source =>
      text().withDefault(const Constant('android_usage'))();
  TextColumn get category => text().nullable()();
  BoolColumn get isDistracting =>
      boolean().withDefault(const Constant(false))();
  DateTimeColumn get syncTime =>
      dateTime().withDefault(currentDateAndTime)(); // Log sync timestamp
