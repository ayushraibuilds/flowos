...
extension FocusProtectionLevelDetails on FocusProtectionLevel {
  ...
  String get description => switch (this) {
        FocusProtectionLevel.softReturn => 'A kind cue welcomes you back; your timer keeps moving.',
        FocusProtectionLevel.pauseAndProtect => 'Your timer pauses when you leave FlowOS, so you can return by choice.',
        FocusProtectionLevel.intentionalExit => 'Pause on leave, plus a five-second reflection before ending a session.',
      };

  bool get pausesWhenLeaving => this != FocusProtectionLevel.softReturn;

  bool get requiresExitReflection => this == FocusProtectionLevel.intentionalExit;
}
