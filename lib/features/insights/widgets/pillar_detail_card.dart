    ...
    switch (pillar) {
      case ScorePillar.focus:
        ...
        details = [
          ...
          _buildDetailRow(
            'Formula',
            'Calculated using actual completed focus session minutes.',
          ),
        ];
        break;
      case ScorePillar.intent:
        ...
        details = [
          ...
          _buildDetailRow(
            'Morning Intention Weight',
            '20% of Intent (5 pts max)',
          ),
          _buildDetailRow(
            'Structure',
            'Intent tracks planning MITs and committing to a daily focus rhythm.',
          ),
        ];
        break;
      case ScorePillar.attention:
        ...
        if (result.isIncomplete || result.attentionPoints == null) {
          ...
          details = [
            ...
            _buildDetailRow(
              'Why?',
              'Usage Access is disconnected, or coverage is partial. Attention points are normalized out.',
            ),
          ];
        } else {
          ...
          details = [
            ...
            _buildDetailRow(
              'Budget limit',
              'Evaluated against scroll budget limit',
            ),
            _buildDetailRow(
              'Structure',
              'Fewer distracting minutes = higher score.',
            ),
          ];
        }
        break;
      case ScorePillar.care:
        ...
        details = [
          _buildDetailRow(
            ...
            'Tending soil after scrolling (1/3 weight)',
          ),
          _buildDetailRow(
            'Energy Logs',
            '3x daily logs completed (1/3 weight)',
          ),
          _buildDetailRow(
            'Shutdown Ritual',
            'Completing daily reflection (1/3 weight)',
          ),
        ];
        break;
    }
