            ...
            return Padding(
              ...
              child: Row(
                ...
                children: List.generate(7, (colIndex) {
                  ...
                  if (cellIndex < leadingPaddingCells ||
      ...
      onTap: () {
        if (metric != null && onDayTapped != null) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(
                '${DateFormat('MMM d').format(date)}: ${metric == null ? 'No data' : (metric.isIncomplete ? 'Incomplete score (${metric.score})' : 'Score: ${metric.score}')}',
              ),
