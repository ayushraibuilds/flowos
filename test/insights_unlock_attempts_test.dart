...
void main() {
  ...
  test(
    'insightUnlockAttemptsProvider aggregates data correctly when database is empty',
    () async {
      ...
      final attempts = await container.read(
        insightUnlockAttemptsProvider.future,
      );
  ...
  test(
    'insightUnlockAttemptsProvider aggregates total attempts, peak hour, and most blocked target',
    () async {
      final container = ProviderContainer(
        overrides: [databaseProvider.overrideWithValue(db)],
      );
